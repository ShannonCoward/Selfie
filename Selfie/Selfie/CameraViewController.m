...
//    imagePickerController.showsCameraControls = NO;
    ...
    UIButton * takeButton = [[UIButton alloc] initWithFrame:CGRectMake
                         ((SCREEN_WIDTH- buttonSize) / 2, SCREEN_HEIGHT - 40 - buttonSize, buttonSize, buttonSize)];
